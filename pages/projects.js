      ...
      <main className="bg-[#3331C4] pb-12">
        ...
        <div className="container flex flex-col px-6 py-4 mx-auto space-y-6 lg:h-128 lg:py-16 lg:flex-row lg:items-center">
            <div className="flex items-center justify-center w-full lg:w-1/2">
                <img className="object-contain w-full h-full max-w-2xl rounded-3xl" src="/assets/projects/p-genztechies.svg" alt="p-genztechies">
            </div>
            ...
            <div className="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
                <div className="max-w-lg lg:mx-12 lg:order-2">
                    ...
                    <div className="my-6">
                        <a href="" className="bg-white p-4 font-light rounded-full text-[#29279B]">

    ...
    return (
        <section className="bg-slate-100 my-10 min-h-screen py-10 md:p-10">
            <div className="container w-full">
                <h1 className="text-primary uppercase font-semibold text-lg">projects</h1>
                <p className="text-slate-900 text-3xl font-bold my-5 md:w-1/2">Awesome projects from the community members</p>
